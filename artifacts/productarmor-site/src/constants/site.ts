export const SITE = {
  ...
  description:
    "Product Armor Packaging Pvt Ltd manufactures ISO 9001:2015 & WHO-GMP certified pharmaceutical-grade HDPE bottles, child-resistant (CR) caps and continuous thread (CT) caps for regulated markets across India, USA, Europe, the Middle East and Asia.",
  founded: "2018",
} as const;
