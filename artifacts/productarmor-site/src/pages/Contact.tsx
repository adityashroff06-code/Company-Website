    ...
    <div className="pt-16">
      ...
      <section className="grain relative overflow-hidden bg-[#0a1626] pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="font-display text-5xl sm:text-6xl font-light text-white tracking-tight mb-4">Get in Touch</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div>
                <h2 className="font-display text-2xl font-semibold text-[#0a1626] tracking-tight mb-2">
              ...
              <div className="space-y-4">
                <a href={`tel:${phone.replace(/\s+/g, "")}`} className="flex items-start gap-4 p-4 bg-white rounded-lg border border-gray-100 hover:border-[#4164a8]/30 hover:shadow-sm transition-all duration-200 group">
                  ...
                  <div>
                    ...
                    <div className="text-[#0a1626] font-semibold text-sm">{phone}</div>
                  </div>
                </a>

                <a href={`mailto:${email}`} className="flex items-start gap-4 p-4 bg-white rounded-lg border border-gray-100 hover:border-[#4164a8]/30 hover:shadow-sm transition-all duration-200 group">
                  <div className="w-10 h-10 bg-[#4164a8]/10 rounded-lg flex items-center justify-center shrink-0 group-hover:bg-[#4164a8] transition-colors">
                  ...
                  <div>
                    ...
                    <div className="text-[#0a1626] font-semibold text-sm">{email}</div>
                  </div>
                </a>
                ...
                <a
                  ...
                  className="flex items-start gap-4 p-4 bg-white rounded-lg border border-gray-100 hover:border-[#25d366]/40 hover:shadow-sm transition-all duration-200 group"
                >
                  ...
                  <div>
                    ...
                    <div className="text-[#0a1626] font-semibold text-sm">{whatsapp}</div>
                  </div>
                </a>
                ...
                <a
                  ...
                  target="_blank" rel="noopener noreferrer"
                  className="flex items-start gap-4 p-4 bg-white rounded-lg border border-gray-100 hover:border-[#4164a8]/30 hover:shadow-sm transition-all duration-200 group"
                >
                  <div className="w-10 h-10 bg-[#4164a8]/10 rounded-lg flex items-center justify-center shrink-0 group-hover:bg-[#4164a8] transition-colors">
                  ...
                  <div>
                    ...
                    <div className="text-[#0a1626] font-semibold text-sm">Product Armor Packaging</div>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-[#0a1626] font-medium text-sm leading-relaxed">{address}</div>
                  </div>
                </a>
              </div>
            </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-8">
                {sent ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-xl font-semibold text-[#0a1626] mb-2">Message Sent!</h3>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                      <h2 className="text-xl font-semibold text-[#0a1626] mb-1">Send us a Message</h2>
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 bg-[#0a1626] hover:bg-[#1a2f52] disabled:opacity-60 text-white font-semibold px-6 py-3 rounded-sm tracking-wide transition-all duration-200 hover:shadow-md"
                    >
                      {loading ? (
      ...
      {/* Google Map */}
      <section className="pb-24 bg-[#f6f7f9]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
