      ...
      <div>
        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="font-display text-4xl font-light text-[#0a1626] tracking-tight mb-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={s.l} className="text-center bg-[#f6f7f9] rounded-lg p-4 border border-gray-100">
        ...
        <section className="py-24 bg-[#f6f7f9]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              <h2 className="font-display text-4xl font-light text-[#0a1626] tracking-tight mb-4">Our Core Values</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {values.map(v => (
                <div key={v.title} className="bg-white rounded-lg p-8 shadow-sm hover:shadow-md border border-gray-100 flex gap-5">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#0a1626] mb-2">{v.title}</h3>
        ...
        <section className="grain relative bg-[#0a1626] overflow-hidden py-16">
          <div className="relative max-w-3xl mx-auto px-4 text-center">
            <h2 className="font-display text-2xl font-light text-white tracking-tight mb-3">Partner With Us</h2>
