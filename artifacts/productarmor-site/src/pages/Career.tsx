...
function useReveal(dependency: number) {
  useEffect(() => {
    const elements = document.querySelectorAll<HTMLElement>(".career-reveal, .reveal, .reveal-left, .reveal-right");
    const observer = new IntersectionObserver(
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            entry.target.classList.add("career-revealed", "visible");
...
export default function Career() {
  ...
  return (
    <main className="career-page overflow-hidden bg-[#f6f7f9] text-[#0a1626]">
      <style>{`
        .career-reveal {
          opacity: 0;
      ...
      `}</style>
      <section className="grain relative isolate overflow-hidden bg-[#0a1626] text-white">
        <div className="pointer-events-none absolute -right-24 top-14 h-96 w-96 rounded-full border border-white/10" />
        <div className="pointer-events-none absolute -right-8 top-28 h-64 w-64 rounded-full border border-[#c2a15f]/30" />
        ...
        <div className="relative mx-auto max-w-7xl px-5 pb-16 pt-32 sm:px-8 sm:pb-24 lg:px-12">
          <Breadcrumb items={[{ label: "Careers" }]} />
          <div>
            <div className="career-reveal">
              <p className="lux-kicker mb-5 flex items-center gap-3 text-[#c2a15f]">
                <span className="h-px w-8 bg-[#c2a15f]" />
                Careers at Product Armor
              </p>
              <h1 className="whitespace-nowrap font-display font-light text-[1.1rem] leading-none tracking-tight text-white sm:text-3xl md:text-5xl lg:text-[4.75rem]">
                Build the Future. <span className="text-[#93b4e8]">Protect What Matters.</span>
              </h1>
              <div className="mt-10 grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(300px,.72fr)] lg:items-center lg:gap-16">
                <div>
                  ...
                  <a
                    ...
                    className="mt-9 inline-flex items-center gap-3 border-b border-[#c2a15f] pb-2 text-sm font-semibold text-[#c2a15f] transition-transform duration-300 hover:translate-x-1"
                  >
      ...
      <nav aria-label="Career page sections" className="border-b border-[#0a1626]/10 bg-[#f6f7f9]">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-5 overflow-x-auto px-5 py-4 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#597080] sm:px-8 lg:px-12">
          <span className="hidden whitespace-nowrap text-[#0a1626] sm:inline">Join the build</span>
          <div className="flex min-w-max items-center gap-6 sm:gap-9">
            <a href="#values" data-testid="link-career-values" className="transition-colors hover:text-[#4164a8]">What defines us</a>
            <a href="#why-join" data-testid="link-career-why-join" className="transition-colors hover:text-[#4164a8]">Why join</a>
            <a href="#openings" data-testid="link-career-openings" className="transition-colors hover:text-[#4164a8]">Openings</a>
            <a href="#apply" data-testid="link-career-apply" className="transition-colors hover:text-[#4164a8]">Apply</a>
          </div>
        </div>
      </nav>

      <section id="values" className="bg-[#f6f7f9] py-24 sm:py-28">
        <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-12">
          <div className="grid gap-12 lg:grid-cols-[.62fr_1.38fr] lg:gap-24">
            <div className="career-reveal lg:sticky lg:top-28 lg:self-start">
              <p className="lux-kicker mb-5 block text-[#b08d3e]">01 / How we work</p>
              <h2 className="max-w-md font-display font-light text-5xl leading-[0.98] tracking-tight text-[#0a1626] sm:text-6xl">
                What Defines Us
              </h2>
              ...
              <div className="mt-12 hidden h-28 w-px bg-[#c2a15f] lg:block" />
            </div>
            <div className="divide-y divide-[#d5dede] border-t border-[#0a1626]/20">
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between sm:block">
                      <span className="font-mono text-xs text-[#b08d3e]">{value.number}</span>
                      <ValueIcon size={21} strokeWidth={1.5} className="text-[#b08d3e] sm:mt-7" />
                    </div>
                    <h3 className="max-w-[220px] text-xl font-semibold leading-tight tracking-[-0.02em] text-[#0a1626]">{value.title}</h3>
      ...
      <section id="why-join" className="relative overflow-hidden bg-white py-24 sm:py-28">
        <div className="pointer-events-none absolute -left-32 top-16 h-72 w-72 rounded-full border border-[#4164a8]/10" />
        <div className="pointer-events-none absolute -left-20 top-28 h-48 w-48 rounded-full border border-[#b08d3e]/20" />
        <div className="relative mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-[.75fr_1.25fr] lg:gap-28 lg:px-12">
          <div className="career-reveal">
            <p className="lux-kicker mb-5 block text-[#b08d3e]">02 / Make your mark</p>
            <h2 className="max-w-md font-display font-light text-5xl leading-[0.98] tracking-tight text-[#0a1626] sm:text-6xl">
              Why Join Product Armor?
            </h2>
            <div className="mt-8 flex items-start gap-3 text-[#627684]">
              <ArrowRight size={18} className="mt-1 shrink-0 text-[#b08d3e]" />
              <p className="max-w-xs leading-7">At Product Armor, you'll have the opportunity to:</p>
            </div>
          </div>
          <div className="career-reveal border-t border-[#0a1626]/20" style={{ transitionDelay: "100ms" }}>
            {joiningReasons.map((reason, index) => (
              <div
                key={reason}
                data-testid={`why-join-item-${index + 1}`}
                className="flex gap-5 border-b border-[#0a1626]/15 py-6 text-lg leading-7 text-[#0a1626] sm:gap-8 sm:py-7 sm:text-xl"
              >
                <span className="font-mono text-xs text-[#b08d3e]">0{index + 1}</span>
                <p>{reason}</p>
              </div>
            ))}
          </div>
      ...
      <section id="openings" className="grain relative overflow-hidden bg-[#0a1626] py-24 text-white sm:py-28">
        <div className="relative mx-auto max-w-6xl px-5 sm:px-8 lg:px-12">
          ...
          {openingsLoading ? (
            ...
            <div data-testid="error-current-openings" className="border border-[#c2a15f]/40 bg-[#c2a15f]/10 p-7">
              ...
              <button
                ...
                className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-[#c2a15f] transition-transform hover:translate-x-1"
              >
            ...
            <div data-testid="empty-current-openings" className="border border-white/15 bg-white/[0.05] p-8 sm:p-10">
              <BriefcaseBusiness size={24} strokeWidth={1.4} className="text-[#c2a15f]" />
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="group flex w-full items-center gap-4 py-6 text-left transition-colors hover:text-[#c2a15f] sm:gap-7 sm:py-7"
                    >
                      <span className="flex h-11 w-11 shrink-0 items-center justify-center border border-white/20 text-[#c2a15f] transition-colors group-hover:border-[#c2a15f]">
                      ...
                      <ChevronDown size={20} className={`shrink-0 text-[#c2a15f] transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`} />
                    </button>
                    {isOpen && (
                      <div data-testid={`opening-details-${role.id}`} className="grid gap-8 border-t border-white/15 pb-8 pt-7 sm:grid-cols-[1fr_1fr] sm:pl-[70px]">
                        ...
                        <div>
                          <p className="lux-kicker mb-4 text-[#c2a15f]">What we look for</p>
                          <ul className="space-y-3">
                            {role.requirements.map((requirement) => (
                              <li key={requirement} className="flex gap-3 text-sm leading-6 text-white/70">
                                <Check size={15} className="mt-1 shrink-0 text-[#c2a15f]" />
                          ...
                          <button
                            ...
                            className="mt-7 inline-flex items-center gap-2 border-b border-[#c2a15f] pb-1 text-sm font-semibold text-[#c2a15f] transition-transform hover:translate-x-1"
                          >
      ...
      <section id="apply" className="bg-[#f6f7f9] py-24 sm:py-28">
        <div className="mx-auto max-w-6xl px-5 sm:px-8 lg:px-12">
          <div className="grid gap-12 lg:grid-cols-[.7fr_1.3fr] lg:gap-24">
            <div className="career-reveal">
              <p className="lux-kicker mb-5 block text-[#b08d3e]">04 / Start a conversation</p>
              <h2 className="font-display font-light text-5xl leading-[0.98] tracking-tight text-[#0a1626] sm:text-6xl">Submit Your Application</h2>
              <p className="mt-7 max-w-sm text-base leading-7 text-[#627684]">
              ...
              <div className="mt-10 flex items-center gap-3 text-xs uppercase tracking-[0.16em] text-[#627684]">
                <span className="h-px w-8 bg-[#b08d3e]" /> Product Armor / People
              </div>
            </div>

            <div data-testid="application-form-panel" className="career-reveal border-t border-[#0a1626]/20 pt-7" style={{ transitionDelay: "100ms" }}>
              {sent ? (
                <div data-testid="status-application-received" className="border border-[#4164a8]/20 bg-white p-8 sm:p-12">
                  <CheckCircle2 size={34} strokeWidth={1.4} className="text-[#4164a8]" />
                  <h3 className="mt-7 font-display font-light text-4xl tracking-tight text-[#0a1626]">Application Received!</h3>
                  ...
                  <button
                    ...
                    className="mt-8 inline-flex items-center gap-2 text-sm font-semibold text-[#4164a8] transition-transform hover:translate-x-1"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-6" data-testid="form-application">
                  <div className="grid gap-6 sm:grid-cols-2">
                    <label className="block">
                      <span className="lux-kicker mb-2 block text-[#627684]">Full Name *</span>
                      <input
                        type="text"
                        required
                        value={form.name}
                        ...
                        className="w-full border-0 border-b border-[#bfcdd2] bg-transparent px-0 py-3 text-sm text-[#0a1626] outline-none transition-colors placeholder:text-[#9aaab1] focus:border-[#4164a8] focus:ring-0"
                        placeholder="Your full name"
                      />
                    </label>
                    <label className="block">
                      <span className="lux-kicker mb-2 block text-[#627684]">Email Address *</span>
                      <input
                        type="email"
                        required
                        value={form.email}
                  ...
                  <div className="grid gap-6 sm:grid-cols-2">
                    <label className="block">
                      <span className="lux-kicker mb-2 block text-[#627684]">Phone *</span>
                      <input
                        type="tel"
                        required
                        value={form.phone}
                    ...
                    <label className="block">
                      <span className="lux-kicker mb-2 block text-[#627684]">Position *</span>
                      <select
                        required
                        value={form.position}
                        data-testid="select-application-position"
                        onChange={(event) => setForm((current) => ({ ...current, position: event.target.value }))}
                        className="w-full border-0 border-b border-[#bfcdd2] bg-transparent px-0 py-3 text-sm text-[#0a1626] outline-none transition-colors focus:border-[#4164a8] focus:ring-0"
                      >
                  ...
                  <label className="block">
                    <span className="lux-kicker mb-2 block text-[#627684]">Message / Cover Note *</span>
                    <textarea
                      required
                      rows={5}
                      value={form.message}
                      ...
                      className="w-full resize-none border border-[#bfcdd2] bg-white px-4 py-3 text-sm leading-6 text-[#0a1626] outline-none transition-colors placeholder:text-[#9aaab1] focus:border-[#4164a8] focus:ring-1 focus:ring-[#4164a8]/20"
                      placeholder="Tell us about your experience, notice period and why you'd like to join our team..."
                    />
                  </label>
                  <div className="flex items-start gap-3 border border-[#0a1626]/10 bg-white p-4 text-xs leading-5 text-[#71828a]">
                    <Paperclip size={15} className="mt-0.5 shrink-0 text-[#4164a8]" />
                  ...
                  <button
                    ...
                    className="inline-flex w-full items-center justify-center gap-3 rounded-sm bg-[#0a1626] px-6 py-4 text-sm font-semibold tracking-wide text-white transition-all duration-300 hover:bg-[#1a2f52] disabled:cursor-wait disabled:opacity-70"
                  >
                    {loading ? (
                      <>
      ...
      <section className="grain relative overflow-hidden bg-[#0a1626] py-24 text-white">
        <div className="relative mx-auto grid max-w-6xl gap-10 px-5 sm:px-8 lg:grid-cols-[1fr_auto] lg:items-end lg:px-12">
          ...
          <Link
            ...
            className="career-reveal inline-flex items-center justify-center gap-3 rounded-sm border border-white/30 px-6 py-4 text-sm font-semibold tracking-wide transition-colors hover:border-white hover:bg-white hover:text-[#0a1626]"
