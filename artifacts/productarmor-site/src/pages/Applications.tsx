...
export default function Applications() {
  ...
  return (
    <div className="pt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {applications.map((app, i) => (
              ...
              >
                ...
                <h3 className="font-semibold text-[#0a1626] text-lg mb-2">
                  {app.name}
                </h3>
                ...
                <div className="border-t border-gray-100 pt-3">
                  <div className="lux-kicker text-[#b08d3e] mb-1">
                    Recommended fit
                  </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="reveal bg-[#f6f7f9] rounded-lg border border-gray-100 p-8 sm:p-12">
            <div className="flex items-start gap-4 mb-8">
              ...
              <div>
                <h2 className="font-display text-2xl font-light text-[#0a1626] tracking-tight mb-2">
                  Closure &amp; Liner Selection
                </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                >
                  <h3 className="font-semibold text-[#0a1626] text-sm mb-2">
                    {item.t}
                  </h3>
                  <p className="text-gray-500 text-sm leading-relaxed">
                    {item.d}
      ...
      <section className="grain relative bg-[#0a1626] overflow-hidden py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal">
          <h2 className="font-display text-3xl sm:text-4xl font-light text-white tracking-tight mb-4">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 bg-white hover:bg-[#e9edf4] text-[#0a1626] font-semibold px-8 py-3.5 rounded-sm tracking-wide transition-all duration-200 hover:shadow-xl hover:scale-105"
          >
